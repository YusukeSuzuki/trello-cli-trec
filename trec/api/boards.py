...
def create(
  name: str, *args: Any, description: str=None, idOrganization: str=None,
  api_key: str, api_token: str, **kwargs: Any) -> Dict[str, any]:
  ...
  if idOrganization is not None:
    query = { 'idOrganization': idOrganization, **query }
